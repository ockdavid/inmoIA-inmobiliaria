...
(function () {
  ...
  var T = {
    es: {
      ...
      calc_in_savings: "Ahorro disponible (€)", calc_in_rate: "Tipo de interés anual (%)", calc_in_term: "Plazo (años)",
      calc_rate_hint: "Hipoteca variable = Euríbor + tu diferencial. Sube el tipo para ver cómo te afectaría una subida.",
      ...
      calc_disclaimer: "Cálculo orientativo, no es una oferta de financiación. Asume financiación de hasta el 80 % del precio y gastos de compra de ~10 %. Las condiciones reales dependen de cada banco y de tu perfil.",
    ...
    en: {
      ...
      calc_in_savings: "Available savings (€)", calc_in_rate: "Annual interest rate (%)", calc_in_term: "Term (years)",
      calc_rate_hint: "Variable mortgage = Euribor + your spread. Raise the rate to see how an increase would affect you.",
      ...
      calc_disclaimer: "Indicative estimate, not a financing offer. It assumes financing of up to 80% of the price and purchase costs of ~10%. Real terms depend on each bank and your profile.",
    ...
    zh: {
      ...
      calc_in_savings: "可用存款（欧元）", calc_in_rate: "年利率（%）", calc_in_term: "贷款期限（年）",
      calc_rate_hint: "浮动房贷 = 欧元区银行间利率（Euribor）+ 您的加点。调高利率可查看上调对您的影响。",
      ...
      calc_disclaimer: "仅供参考，并非融资报价。假设贷款最高为房价的 80%，购房费用约 10%。实际条件取决于各家银行和您的资质。",
