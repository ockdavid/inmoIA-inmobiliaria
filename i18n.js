...
(function () {
  ...
  var T = {
    es: {
      ...
      calc_sub: "Estima tu capacidad de compra con la regla del 35%: tu cuota no debería superar el 35 % de tus ingresos, menos las deudas que ya pagas.",
      calc_in_income: "Ingresos netos del hogar (€/mes)", calc_in_debts: "Deudas mensuales actuales (€/mes)",
      calc_in_savings: "Ahorro disponible (€)", calc_in_financing: "Porcentaje de financiación del banco (%)",
      calc_in_rate: "Tipo de interés fijo anual (%)", calc_in_term: "Plazo (años)",
      calc_rate_hint: "Cálculo con interés fijo durante todo el plazo. Lo habitual es financiar hasta el 80 % del precio.",
      calc_out_price: "Precio máximo de vivienda", calc_out_loan: "Hipoteca máxima", calc_out_payment: "Cuota máxima recomendada",
      calc_out_effort: "Esfuerzo (cuota / ingresos)",
      calc_warn: "Con estos ingresos y deudas no queda cuota disponible. Reduce deudas o revisa los datos.",
      calc_disclaimer: "Cálculo orientativo con interés fijo, no es una oferta de financiación. Asume el porcentaje de financiación que indiques y gastos de compra de ~10 %. Las condiciones reales dependen de cada banco y de tu perfil.",
    ...
    en: {
      ...
      calc_sub: "Estimate your buying power with the 35% rule: your payment shouldn't exceed 35% of your income, minus the debts you already pay.",
      calc_in_income: "Net household income (€/month)", calc_in_debts: "Current monthly debts (€/month)",
      calc_in_savings: "Available savings (€)", calc_in_financing: "Bank financing percentage (%)",
      calc_in_rate: "Fixed annual interest rate (%)", calc_in_term: "Term (years)",
      calc_rate_hint: "Calculated with a fixed rate for the whole term. Banks typically finance up to 80% of the price.",
      calc_out_price: "Maximum property price", calc_out_loan: "Maximum mortgage", calc_out_payment: "Maximum recommended payment",
      calc_out_effort: "Effort (payment / income)",
      calc_warn: "With this income and debts there's no payment capacity left. Reduce debts or review the figures.",
      calc_disclaimer: "Indicative estimate with a fixed rate, not a financing offer. It assumes the financing percentage you enter and purchase costs of ~10%. Real terms depend on each bank and your profile.",
    ...
    zh: {
      ...
      calc_title: "我能买得起多少？",
      calc_sub: "用 35% 规则估算您的购房能力：月供不应超过收入的 35%，再减去您已有的债务。",
      calc_in_income: "家庭净收入（欧元/月）", calc_in_debts: "当前每月债务（欧元/月）",
      calc_in_savings: "可用存款（欧元）", calc_in_financing: "银行贷款比例（%）",
      calc_in_rate: "固定年利率（%）", calc_in_term: "贷款期限（年）",
      calc_rate_hint: "按整个期限的固定利率计算。银行通常最高贷款为房价的 80%。",
      calc_out_price: "最高购房价格", calc_out_loan: "最高贷款额", calc_out_payment: "建议最高月供",
      calc_out_effort: "负担率（月供 / 收入）",
      calc_warn: "以此收入和债务，已无可用月供空间。请减少债务或核对数据。",
      calc_disclaimer: "按固定利率估算，仅供参考，并非融资报价。按您填写的贷款比例计算，购房费用约 10%。实际条件取决于各家银行和您的资质。",
