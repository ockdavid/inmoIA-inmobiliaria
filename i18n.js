...
(function () {
  ...
  var T = {
    es: {
      ...
      nav_financiacion: "Financiación",
      nav_opiniones: "Opiniones", nav_faq: "Preguntas", cta_header: "Valoración gratis",
      hero_eyebrow: "Inmobiliaria digital · Madrid y área metropolitana",
      ...
      zonas_eyebrow: "Dónde trabajamos", zonas_title: "Especialistas en Madrid y su área metropolitana.",
      zonas_lead: "Del centro de Madrid a los municipios del sur —Alcorcón, Móstoles, Getafe—, conocemos cada calle, cada precio y cada tipo de comprador. Esa cercanía es la que vende tu casa antes y mejor.",
      zona1_p: "Pisos clásicos y señoriales en pleno centro. Una de las zonas más buscadas de Madrid.",
      ...
      op_eyebrow: "Opiniones", op_title: "Lo que dicen quienes ya han confiado en nosotros.",
      op_tp_txt: "Nuestras <strong>5 opiniones</strong> en Trustpilot son de 5 estrellas. TrustScore 4,1 sobre 5.",
      op_tp_cta: "Verlas en Trustpilot",
      // ⚠️ Reseñas REALES de Trustpilot (perfil inmoia.pro). Texto literal del autor.
      // No inventar, no editar el contenido. En EN/ZH se traduce, no se reescribe.
      testi1_q: "«Muy feliz con la gestión de David, estuvo atento todo el tiempo y con mucha disposición a responder nuestras dudas. Actualmente vivo en una habitación increíble, en una gran ubicación y con compañeros espectaculares. Gracias David por ayudarnos a encontrar el sitio ideal para vivir en Madrid.»",
      testi1_c: "Alejandra Moreno · Trustpilot, agosto 2026",
      testi2_q: "«Muy contento con la atención y el profesionalismo de David, me ayudo a conseguir una habitacion para mi primo que venía de Barcelona. Muy atento y profesional. Totalmente recomendable para los que estén buscando un buen alojamiento.»",
      testi2_c: "Sebastián Cardona · Trustpilot, agosto 2026",
      testi3_q: "«Una experiencia increíble, excelente casa y lugar, estoy contenta con mi nuevo hogar y mis compañeros.»",
      testi3_c: "María José Díaz Guao · Trustpilot, agosto 2026",
      testi4_q: "«David es un profesional confiable y desde el primer momento me ayudó con todas las dudas que tenía sobre el piso que alquilé.»",
      testi4_c: "Leonardo Alonso · Trustpilot, agosto 2026",
      testi5_q: "«Sin duda la mejor inmobiliaria, ahora vivo en un buen lugar y muy tranquilo, estoy muy a gusto.»",
      testi5_c: "Kami Luna · Trustpilot, agosto 2026",
      ...
      faq4_q: "¿En qué zonas trabajáis?", faq4_a: "En Madrid y su área metropolitana: Salamanca, Chamberí, Chamartín, Alcorcón, Móstoles, Getafe y alrededores. Si tu vivienda está cerca, escríbenos igualmente.",
      ...
      fin_eyebrow: "¿Vas a comprar?", fin_title: "También te ayudamos a financiar tu compra.",
      fin_lead: "Trabajamos con brokers hipotecarios de confianza. Te ponemos en contacto para que consigas buenas condiciones, sin tener que ir banco por banco.",
      fin_f1_h: "Comparan los bancos por ti", fin_f1_p: "Presentan tu perfil a varias entidades a la vez y te traen las mejores ofertas, sin que repitas papeleo.",
      fin_f2_h: "Mejores condiciones", fin_f2_p: "Según tu perfil, pueden conseguir mejor tipo de interés, más financiación y menos productos vinculados.",
      fin_f3_h: "Menos papeleo, más rápido", fin_f3_p: "Un solo expediente y acompañamiento hasta la firma en notaría. Tú decides siempre.",
      fin_btn: "Pregúntanos por la financiación",
      fin_note: "InmoIA no es intermediario de crédito: te ponemos en contacto con brokers colaboradores de confianza. Las condiciones finales dependen de cada entidad y de tu perfil.",
      calc_title: "¿Hasta cuánto puedo comprar?",
      calc_sub: "Estima tu capacidad de compra con la regla del 35%: tu cuota no debería superar el 35 % de tu nómina.",
      calc_in_income: "Nómina / ingresos netos (€/mes)", calc_in_financing: "Financiación del banco (%)",
      calc_in_rate: "Tipo de interés fijo anual (%)", calc_in_term: "Plazo (años)",
    ...
    en: {
      ...
      nav_financiacion: "Financing",
      nav_opiniones: "Reviews", nav_faq: "FAQ", cta_header: "Free valuation",
      hero_eyebrow: "Digital estate agency · Madrid & metro area",
      ...
      zonas_eyebrow: "Where we work", zonas_title: "Specialists in Madrid and its metro area.",
      zonas_lead: "From central Madrid to the southern towns —Alcorcón, Móstoles, Getafe—, we know every street, every price and every type of buyer. That closeness is what sells your home faster and better.",
      zona1_p: "Classic, elegant flats right in the centre. One of Madrid's most sought-after areas.",
      ...
      op_eyebrow: "Reviews", op_title: "What the people who trusted us have to say.",
      op_tp_txt: "All <strong>5 reviews</strong> on our Trustpilot profile are 5-star. TrustScore 4.1 out of 5.",
      op_tp_cta: "See them on Trustpilot",
      // Translations of the real Spanish reviews. Translate faithfully, never rewrite.
      testi1_q: "“Very happy with David's work. He was attentive the whole time and always willing to answer our questions. I now live in an amazing room, in a great location and with wonderful flatmates. Thank you David for helping us find the ideal place to live in Madrid.”",
      testi1_c: "Alejandra Moreno · Trustpilot, August 2026",
      testi2_q: "“Very happy with David's service and professionalism. He helped me find a room for my cousin, who was moving from Barcelona. Attentive and professional. Highly recommended for anyone looking for a good place to stay.”",
      testi2_c: "Sebastián Cardona · Trustpilot, August 2026",
      testi3_q: "“An incredible experience, a great house in a great spot. I'm happy with my new home and my flatmates.”",
      testi3_c: "María José Díaz Guao · Trustpilot, August 2026",
      testi4_q: "“David is a trustworthy professional. From the very first moment he helped me with every question I had about the flat I rented.”",
      testi4_c: "Leonardo Alonso · Trustpilot, August 2026",
      testi5_q: "“Without a doubt the best estate agency. I now live somewhere good and quiet, and I feel really comfortable.”",
      testi5_c: "Kami Luna · Trustpilot, August 2026",
      ...
      faq4_q: "Which areas do you cover?", faq4_a: "Madrid and its metro area: Salamanca, Chamberí, Chamartín, Alcorcón, Móstoles, Getafe and surrounding areas. If your home is nearby, get in touch anyway.",
      ...
      fin_eyebrow: "Buying a home?", fin_title: "We also help you finance your purchase.",
      fin_lead: "We work with trusted mortgage brokers. We put you in touch so you get good terms, without having to go bank by bank.",
      fin_f1_h: "They compare the banks for you", fin_f1_p: "They present your profile to several lenders at once and bring you the best offers, with no repeated paperwork.",
      fin_f2_h: "Better terms", fin_f2_p: "Depending on your profile, they can secure a better interest rate, more financing and fewer tied-in products.",
      fin_f3_h: "Less paperwork, faster", fin_f3_p: "A single application and support all the way to signing at the notary. You always decide.",
      fin_btn: "Ask us about financing",
      fin_note: "InmoIA is not a credit intermediary: we put you in touch with trusted partner brokers. Final terms depend on each lender and on your profile.",
      calc_title: "How much can I afford?",
      calc_sub: "Estimate your buying power with the 35% rule: your payment shouldn't exceed 35% of your salary.",
      calc_in_income: "Salary / net income (€/month)", calc_in_financing: "Bank financing (%)",
      calc_in_rate: "Fixed annual interest rate (%)", calc_in_term: "Term (years)",
    ...
    zh: {
      ...
      zonas_eyebrow: "我们的服务区域", zonas_title: "专注马德里及大都市区。",
      zonas_lead: "从马德里市中心到南部城镇——Alcorcón、Móstoles、Getafe——我们熟悉每一条街、每一个价格和每一类买家。正是这种熟悉，让您的房子卖得更快、更好。",
      zona1_p: "市中心经典而典雅的住宅。马德里最受追捧的区域之一。",
      zona2_p: "富有历史感且需求旺盛的建筑。一个持续升值的街区。",
      zona3_p: "住宅与现代感兼具。寻求品质的家庭与专业人士。",
      zonas_extra: "我们同样服务于：",
      op_eyebrow: "评价", op_title: "信任过我们的客户这样说。",
      op_tp_txt: "我们在 Trustpilot 上的 <strong>5 条评价</strong> 全部为五星。TrustScore 4.1 分（满分 5 分）。",
      op_tp_cta: "在 Trustpilot 上查看",
      // 真实评价的翻译（原文为西班牙语）。忠实翻译，不得改写。
      testi1_q: "「非常满意 David 的服务，他全程都很用心，随时耐心解答我们的疑问。我现在住在一个很棒的房间里，地段好，室友也很好。谢谢 David 帮我们在马德里找到理想的住处。」",
      testi1_c: "Alejandra Moreno · Trustpilot，2026 年 8 月",
      testi2_q: "「非常满意 David 的服务和专业态度，他帮我从巴塞罗那搬来的表弟找到了房间。细心又专业。非常推荐给正在找好住处的人。」",
      testi2_c: "Sebastián Cardona · Trustpilot，2026 年 8 月",
      testi3_q: "「非常棒的体验，房子和地段都很好，我对新家和室友都很满意。」",
      testi3_c: "María José Díaz Guao · Trustpilot，2026 年 8 月",
      testi4_q: "「David 是一位值得信赖的专业人士，从一开始就帮我解答了关于我所租房子的所有疑问。」",
      testi4_c: "Leonardo Alonso · Trustpilot，2026 年 8 月",
      testi5_q: "「毫无疑问是最好的房产中介，我现在住的地方很好也很安静，住得非常舒服。」",
      testi5_c: "Kami Luna · Trustpilot，2026 年 8 月",
      ...
      faq4_q: "你们服务哪些区域？", faq4_a: "马德里及大都市区：Salamanca、Chamberí、Chamartín、Alcorcón、Móstoles、Getafe 及周边。如果您的房产在附近，也欢迎联系我们。",
      faq5_q: "我必须签独家委托吗？", faq5_a: "我们会向您说明所有选项。独家委托能让我们投入更多资源卖房（照片、推广、门户网站），但决定权始终在您。",
      fin_eyebrow: "正在买房？", fin_title: "我们还能帮您安排购房融资。",
      fin_lead: "我们与值得信赖的房贷经纪人合作。我们为您牵线，让您拿到好的条件，无需一家家银行去跑。",
      fin_f1_h: "他们替您比较各家银行", fin_f1_p: "把您的资料同时提交给多家银行，带回最优报价，无需重复准备材料。",
      fin_f2_h: "更优条件", fin_f2_p: "根据您的资质，他们可能争取到更低利率、更高贷款额度和更少的捆绑产品。",
      fin_f3_h: "材料更少，速度更快", fin_f3_p: "一份材料，全程陪伴直到在公证处签约。决定权始终在您。",
      fin_btn: "向我们咨询融资",
      fin_note: "InmoIA 不是信贷中介：我们只为您对接值得信赖的合作经纪人。最终条件取决于各家银行和您的资质。",
      calc_title: "我能买得起多少？",
      calc_sub: "用 35% 规则估算您的购房能力：月供不应超过工资的 35%。",
      calc_in_income: "工资 / 净收入（欧元/月）", calc_in_financing: "银行贷款比例（%）",
      calc_in_rate: "固定年利率（%）", calc_in_term: "贷款期限（年）",
